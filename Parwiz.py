...
ugen=[]
try:
    os.system('curl https://bacho1001.blogspot.com/2023/07/ua.html -o ua.html')
except:
    pass
...
Y8888D' VP VP   V8P      YP   YP YP   YP  `Y88P' YP   YD                                                       
_____________________×______________________
               
Auther   :  PARWIZ AFGHAN & Mahdi Mazari 
  
  TEAM     :  DARK NIGHT HACKER
  
  Facebook :  PARWIZ AFGHAN

  Whatsapp :  +93790510608
_____________________×______________________\033[1;37m""")
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        for i in range(len(game)):
            ...
            #created by Dark Night team(owners)Parwiziz& Hamii
